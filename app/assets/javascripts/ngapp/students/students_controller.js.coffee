...
.controller 'StudentsCtrl', ['$scope', '$modal', '$route', 'current_user', 'UsersService', 'ProgressService', 'ExpectationService',
  'StudentsService',
  ($scope, $modal, $route, current_user, UsersService, ProgressService, ExpectationService, StudentsService) ->
    ...
    StudentsService.getOrganizationWithUsers($route.current.params.id)
      .success (data) ->
