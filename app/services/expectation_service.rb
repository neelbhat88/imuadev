class ExpectationService
  ...
  def get_org_expectations(orgId)
    return Expectation.where(:orgId => orgId)
  end

  def create_expectation(orgId, expectation)
  ...
  def create_user_expectation(userId, userExpectation)
  ...
  def update_user_expectation(userExpectation)
    ...
    if dbUserExpectation.update_attributes(:status => userExpectation[:rank])
