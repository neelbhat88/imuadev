    ...
    when Constants.SubModules[:YES_NO]
      ...
      # ONEGOAL_HACK START
        ...
        when "2-year"
          ...
          custom.icon = "https://imuaproduction.s3.amazonaws.com/images/Academics.jpg"
        when "4-year"
          custom.title = "4-year Task"
          custom.icon = "https://imuaproduction.s3.amazonaws.com/images/Service.jpg"
        when "Assignments"
          custom.title = "Assignments Task"
          custom.icon = "https://imuaproduction.s3.amazonaws.com/images/Extracurricular.jpg"
        when "Financial"
          custom.title = "Financial Task"
          custom.icon = "https://imuaproduction.s3.amazonaws.com/images/PDU.jpg"
        when "Campus_Connections"
          custom.title = "Campus Connections Task"
          custom.icon = "https://imuaproduction.s3.amazonaws.com/images/Testing.jpg"
